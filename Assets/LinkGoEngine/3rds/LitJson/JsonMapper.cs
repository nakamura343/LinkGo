...
namespace LitJson
{
    ...
    public class JsonMapper
    {
        ...
        {
            ToWrapper(
                delegate { return new JsonMockWrapper(); }, 
                reader
                );
        }
        ...
        private static void RegisterBaseImporters()
        {
            ...
            importer = delegate (object input)
            {
                return Convert.ToInt32((int)input);
            };
            RegisterImporter(base_importers_table, typeof(int),
                              typeof(int), importer);
            ...
            importer = delegate (object input)
            {
                return Convert.ToString((string)input);
            };
        ...
        private static void RegisterImporter(IDictionary<Type, IDictionary<Type, ImporterFunc>> table,
